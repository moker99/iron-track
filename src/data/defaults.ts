...
export const DEFAULT_FOOD_ITEMS: FoodItem[] = [
  // 蛋白質主力
  { id: 'f-chicken-breast', name: '即食舒肥雞胸肉 (100g)', calories: 120, protein: 24, carbs: 1, fat: 2, servingSize: '100g', category: 'meat' },
  { id: 'f-boiled-egg', name: '水煮全蛋 (大顆/1顆)', calories: 75, protein: 6.5, carbs: 0.6, fat: 5.2, servingSize: '1顆 (55g)', category: 'egg_dairy' },
  { id: 'f-egg-whites', name: '純蛋白液 / 蛋白丁 (100g)', calories: 50, protein: 11, carbs: 0.7, fat: 0.2, servingSize: '100g', category: 'egg_dairy' },
  { id: 'f-whey-isolate', name: '乳清蛋白粉 (分離乳清/1匙)', calories: 115, protein: 25, carbs: 1.5, fat: 0.8, servingSize: '1份 (30g)', category: 'supplement' },
  { id: 'f-beef-steak', name: '牛板腱 / 菲力牛排 (100g)', calories: 145, protein: 22, carbs: 0, fat: 6, servingSize: '100g', category: 'meat' },
  { id: 'f-salmon', name: '香煎大西洋鮭魚 (100g)', calories: 206, protein: 22, carbs: 0, fat: 12.5, servingSize: '100g', category: 'meat' },
  { id: 'f-canned-tuna', name: '水煮鮪魚罐頭 (100g瀝乾)', calories: 105, protein: 24, carbs: 0, fat: 0.8, servingSize: '100g', category: 'meat' },
  { id: 'f-greek-yogurt', name: '無糖希臘式優格 (100g)', calories: 60, protein: 10, carbs: 3.8, fat: 0.4, servingSize: '100g', category: 'egg_dairy' },
  { id: 'f-tofu', name: '傳統板豆腐 (100g)', calories: 88, protein: 8.5, carbs: 1.5, fat: 5.2, servingSize: '100g', category: 'staple' },
  { id: 'f-soy-milk', name: '無糖高纖豆漿 (1瓶/400ml)', calories: 135, protein: 14.5, carbs: 7.2, fat: 5.5, servingSize: '400ml', category: 'egg_dairy' },

  // 優質碳水化合物
  { id: 'f-sweet-potato', name: '蒸地瓜 / 烤番薯 (中條)', calories: 140, protein: 2.2, carbs: 33, fat: 0.3, servingSize: '1條 (約120g)', category: 'staple' },
  { id: 'f-white-rice', name: '熟白米飯 (半碗/100g)', calories: 142, protein: 2.7, carbs: 31.5, fat: 0.4, servingSize: '100g', category: 'staple' },
  { id: 'f-brown-rice', name: '糙米黑米飯 (100g)', calories: 130, protein: 3.1, carbs: 28, fat: 1.1, servingSize: '100g', category: 'staple' },
  { id: 'f-oats', name: '原味大燕麥片 (乾重40g)', calories: 152, protein: 5.2, carbs: 26.5, fat: 2.8, servingSize: '40g', category: 'staple' },
  { id: 'f-banana', name: '練前香蕉 (中等大小/1根)', calories: 105, protein: 1.3, carbs: 27, fat: 0.3, servingSize: '1根 (118g)', category: 'staple' },

  // 蔬菜與健康油脂
  { id: 'f-broccoli', name: '川燙綠花椰菜 (1碗/100g)', calories: 34, protein: 2.8, carbs: 6.6, fat: 0.4, servingSize: '100g', category: 'veggie' },
  { id: 'f-avocado', name: '熟酪梨 (1/4顆/50g)', calories: 80, protein: 1, carbs: 4.2, fat: 7.3, servingSize: '50g', category: 'other' },
  { id: 'f-almonds', name: '原味堅果杏仁 (1小把/15g)', calories: 90, protein: 3.1, carbs: 3.2, fat: 7.8, servingSize: '15g', category: 'other' },
];
